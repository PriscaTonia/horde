...
const OverviewTotalView = () => {
  return (
    <section className="flex flex-col justify-between gap-5 md:flex-row md:gap-[35px]">
...
const contstyles =
  "flex w-full flex-col-reverse items-center justify-between gap-3 rounded-[10px] border border-[#EAECF0] shadow-md px-6 py-7 sm:flex-row";
