...
import { ActualBudgetCategoriesChart } from "./actual-budget-categories-chart";

const ViewActualBudgetCategory = ({
  selectedValue,
  setSelectedValue,
  ...
  return (
    <div className="flex w-full flex-col  rounded-2xl bg-white p-6 shadow-md lg:w-[50%]">
      ...
      <ActualBudgetCategoriesChart />
    </div>
  );
};

export { ViewActualBudgetCategory };
